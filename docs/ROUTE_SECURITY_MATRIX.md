...
| `/api/control/resources` | Staff resource permission | Staff profile facility | Expected resource/waiting versions; idempotent reassignment replay | Resource status/reassignment audit | Real device enrollment, heartbeat and recovery procedure |
