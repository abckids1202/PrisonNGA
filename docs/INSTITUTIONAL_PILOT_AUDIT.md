...
- Visitation now reuses the persisted policy editor for Availability Rules and Operating Hours and the closure workflow for Closures; Appointment Types remains intentionally unavailable until its own eligibility, duration, credit, and approval model exists.
