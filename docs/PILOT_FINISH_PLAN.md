...
- The latest automated baseline is 301 server tests and 13 browser tests. Development E2E covers signed payment settlement and duplicate webhook delivery through a local-only provider adapter; this proves the boundary, not readiness for a real payment provider.
