...
export async function POST(request: Request, context: RouteContext) {
  ...
  try {
    ...
    const session = await d1.prepare(`SELECT vs.id, vs.appointment_id, vs.facility_id, a.visitor_user_id, u.display_name AS visitor_name, a.prisoner_id, a.status AS appointment_status, a.version AS appointment_version,
