...
const requiredTables = ["users", "facilities", "visit_policies", "appointments", "verification_cases", "evidence_documents", "payment_intents", "notifications", "outbox_events", "idempotency_records"];
